...
Intended to be used to fill the hole between two edge borders that are yet to
be connected.

auto_fill is the main function to use.
...
def auto_fill(isQuad:bool=True) -> None:
    """Fills in the empty space between two edge borders with tris and quads

    Args:
        isQuad: If True, the auto_fill function utilises quadrangulate. 
